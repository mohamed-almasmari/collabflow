...
function KanbanBoard({ issues, onMoveIssue }: KanbanBoardProps) {
  ...
  return (
    ...
    >
      <div className="grid gap-5 lg:grid-cols-3">
        <KanbanColumn title="To Do" status="TODO" issues={issues} />
        ...
        <KanbanColumn title="Done" status="DONE" issues={issues} />
      </div>
    </DndContext>
  );
}
